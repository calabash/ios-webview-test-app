...
if [ "${XC_CONFIG}" = "Release" ]; then
  XC_BUILD_DIR="${PWD}/build/app/no-calabash"
  INSTALL_DIR="Products/app/no-calabash"
else
  XC_BUILD_DIR="${PWD}/build/app/embedded-calabash-dylib"
  INSTALL_DIR="Products/app/embedded-calabash-dylib"
fi
